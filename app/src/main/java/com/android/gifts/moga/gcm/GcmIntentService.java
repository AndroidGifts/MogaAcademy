...
public class GcmIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        Log.e(TAG, "Token to be stored: " + token);

        NotificationInteractor notificationInteractor = new NotificationsInteractorImp(getApplicationContext());
        notificationInteractor.registerDevice(token);
